...
function ITCourseDetail({match}) {
  ...
  useEffect(() => {
    axios({
      method: "GET",
      url: `http://127.0.0.1:8000/api/it/${id}/`
    }).then(response => {
  ...
  }, [id]);
{
        return(
            <div>
                ...
                <Container>
  <Row>
    <Col>          <img src={post.image} alt="portfolio-image" class="img-fluid rounded w-100 d-block" />
</Col>
    <Col><h1 class="text-white font-tertiary">{post.name}</h1></Col>
  </Row>
</Container>
</section>
    ...
    <div class="row justify-content-around">
      ...
      <div class="col-lg-3 col-md-4 text-center hover-shadow pt-3">
        <div class="">
          ...
          <h4 class="mb-4">Создание и запись алгоритмов</h4>
          <p>Вы научитесь записывать свои алгоритмы и придавать логику своему приложению.</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-4 text-center hover-shadow pt-3">
        <img src="images/icons/design.png" class="mb-4" alt="icon" />
        <h4 class="mb-4">Дизайн и разработка</h4>
        <p>Вы сможете создавать свой собственный дизайн приложения и разрабатывать серверную часть.</p>
      </div>
      <div class="col-lg-3 col-md-4 text-center hover-shadow pt-3">
        <img src="images/icons/print.png" class="mb-4" alt="icon" />
        <h4 class="mb-4">ПО</h4>
        <p>Вы получите новые знания в написании легкого ПО.</p>
      </div>
    </div>
  </div>
</section>
